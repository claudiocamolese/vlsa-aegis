...
def eval_libero(args: Args) -> None:
    ...
    model_groundingdino = None  # pi0.5 baseline: no GroundingDINO
    # Start evaluation
    ...
    for task_id in task_index:
        ...
        for episode_idx in episode_index:
            ...
            model = env.sim.model
            data = env.sim.data
            # Clean baseline: do NOT move gripper0_eef manually.
            # gripper0_eef is part of the robot model, not a harmless marker.
            eef_body_id = None
